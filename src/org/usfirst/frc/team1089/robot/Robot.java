...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		...
		leftShooter = new Shooter(RobotMap.CAN.LEFT_SHOOTER_TALON_ID, RobotMap.CAN.LEFT_FEEDER_TALON_ID, 0.06, 0, 0, 0.5115, -1);			
		rightShooter = new Shooter(RobotMap.CAN.RIGHT_SHOOTER_TALON_ID, RobotMap.CAN.RIGHT_FEEDER_TALON_ID, 0.06, 0, 0, 0.4796, 1);			
