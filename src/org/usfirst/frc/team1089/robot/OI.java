...
public class OI {
	...
	SendableChooser startPosition, movementOffStart, firstAction, nextMovement, secondAction, shooterType;
...
/*        rightStick2 = new JoystickButton(rightStick, RobotMap.JoystickButtons.BTN2);
		...
		secondAction.addDefault("Stop", AutonEnum.STOP);
		secondAction.addObject("Shoot", AutonEnum.TURN_SHOOT);
    ...
    public AutonEnum getSecondAction() {
    	return (AutonEnum) secondAction.getSelected();
    }
