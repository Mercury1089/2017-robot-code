...
import org.usfirst.frc.team1089.robot.util.MercLinePlot;

public class MercPathPlanner 
{
	 ...
	 * @param path
	 */
	public MercPathPlanner(double[][] path)
	{
 ...
 */
	...
	public static void main(String[] args)
	{
		...
		final MercPathPlanner path = new MercPathPlanner(waypoints);
		...
		if(!GraphicsEnvironment.isHeadless())
		{
			...
			MercLinePlot fig2 = new MercLinePlot(path.smoothCenterVelocity,null,Color.blue);
			fig2.yGridOn();
			fig2.xGridOn();
			...
			MercLinePlot fig1 = new MercLinePlot(path.nodeOnlyPath,Color.blue,Color.green);
			fig1.yGridOn();
			fig1.xGridOn();
	...
	public void poofExample()
	{
		...
		MercLinePlot fig3 = new MercLinePlot(new double[][]{{0.0,0.0}});
		fig3.yGridOn();
		fig3.xGridOn();
		...
		final MercPathPlanner path = new MercPathPlanner(CheesyPath);
		path.calculate(totalTime, timeStep, robotTrackWidth);
		...
		//Velocity
		MercLinePlot fig4 = new MercLinePlot(path.smoothCenterVelocity,null,Color.blue);
		fig4.yGridOn();
		fig4.xGridOn();
		...
		//MercPathPlanner.print(path.heading);
