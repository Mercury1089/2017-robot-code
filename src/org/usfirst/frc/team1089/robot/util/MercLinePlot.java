...
public class MercLinePlot extends JPanel implements ClipboardOwner{
	     ...
	     */
	    public MercLinePlot(double[] yData)
	    {
	    	this(null,yData,Color.red);
	    }
	    
	    public MercLinePlot(double[] yData,Color lineColor, Color marker)
	    {
	     ...
	     */
	    public MercLinePlot(double[] xData, double[] yData)
	    {
	     ...
	     */
	    public MercLinePlot(double[][] data)
	    {
	 ...
	 */
	    public MercLinePlot(double[][] data, Color lineColor, Color markerColor)
	    {
	     ...
	     * @param lineColor is the color the user wishes to be displayed for the line connecting each datapoint
	     */
	    public MercLinePlot(double[] xData, double[] yData,Color lineColor)
	    {
	     ...
	     * not have datapoint markers.
	     */
	    public MercLinePlot(double[] xData, double[] yData,Color lineColor, Color markerColor)
	    {
	    	xLabel = "X axis";
	    	yLabel = "Y axis";
	    	titleLabel = "Title";
	    ...
	    private void menu(JFrame g, final MercLinePlot p )
	    {
	    ...
	    public static void main(String[] args) {
	  	...
	  	MercLinePlot fig2 = new MercLinePlot(data,Color.red, Color.blue);
	  	...
	  	MercLinePlot fig1 =  new MercLinePlot(test,data);
